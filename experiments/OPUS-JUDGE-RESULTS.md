...
| | raw | moderated | human |
|---|---|---|---|
| **alarmism** | 3.74 | **2.09** | **2.00** |
| **optimism** | 2.15 | **2.60** | **2.50** |

Re-measured 2026-08-12 over all 35 runs, including the ten repeat runs; earlier
passes read 3.64 / 2.13 over 20 and 3.59 / 2.09 over 24. The movement is within
the 0.5 test-retest drift in section 2 and reflects a changing run population,
not a changing instrument. Regenerated by
`experiments/human_vs_machine.py`, never typed in.
