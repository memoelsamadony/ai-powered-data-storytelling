 ...
 *
 * Data comes from `getDataset("measles")`, i.e. the generated snapshot in
 * `lib/data/generated/datasets.generated.ts`, which `manage.py
 * build_frontend_data` writes from the same real tables the API serves. The
 * figures are therefore citable; they can be stale, never invented.
 *
    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      <header className="border-b border-hairline pb-6">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted">
          ...
          <code className="font-mono text-xs">lib/data/generated/datasets.generated.ts</code>. Each figure
          below is a <code className="font-mono text-xs">ChartPayload</code> and nothing more, so
          anything that emits one of these objects renders identically. The numbers are the
          generated snapshot of the real tables, so they can be stale but are never invented.
        </p>
      </header>
